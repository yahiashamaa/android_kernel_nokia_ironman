...
enum{
	...
	HARDWARE_GPS,
	HARDWARE_FM,
	HARDWARE_NFC, //bug589770,gongmingjie.wt,add,20201015,nfc bringup
	HARDWARE_BATTERY_ID,
	...
	//+bug584789,chenbocheng.wt,ADD,2020/10/14,add wide angle and macro camera info for mmigroup apk
        HARDWARE_SMARTPA_IC_INFO,  //Bug589753  liujun5.wt 20201016 add for Audio PA
	HARDWARE_BOARD_ID,
...
#define HARDWARE_MACRO_CAM_GET                    _IOWR(HARDWARE_ID, 0x38, char[HARDWARE_MAX_ITEM_LONGTH])      //  微距CAM
#define HARDWARE_MACRO_CAM_MOUDULE_ID_GET         _IOWR(HARDWARE_ID, 0x39, char[HARDWARE_MAX_ITEM_LONGTH])      //  微距CAM模组厂
#define HARDWARE_MACRO_CAM_EFUSEID_GET            _IOWR(HARDWARE_ID, 0x3A, char[HARDWARE_MAX_ITEM_LONGTH])      //  微距CAM efuseId
#define HARDWARE_MACRO_CAM_SENSORID_GET           _IOWR(HARDWARE_ID, 0x3B, char[HARDWARE_MAX_ITEM_LONGTH])      //  微距CAM sensorId
//-bug584789,chenbocheng.wt,ADD,2020/10/14,add wide angle and macro camera info for mmigroup apk

#define HARDWARE_SMARTPA_IC_INFO_GET              _IOWR(HARDWARE_ID, 0x40, char[HARDWARE_MAX_ITEM_LONGTH])      //Bug589753  liujun5.wt 20201016 add for Audio PA
