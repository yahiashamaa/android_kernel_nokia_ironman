...
#define FT8615_IC_CHIP_ID   0x86
#define FT8615_LIDE_VENDOR_ID    0x60
...
static void fts_hardwareinfo_set(void)
{
	...
	if(tp_vendor_id== FT8615_LIDE_VENDOR_ID)
	{
		snprintf(vendor_id,HARDWARE_MAX_ITEM_LONGTH,"LIDE");
	}else {
		snprintf(vendor_id,HARDWARE_MAX_ITEM_LONGTH,"Other vendor");
	}

	if(tp_ic_type == FT8615_IC_CHIP_ID)
	{
		snprintf(ic_name,HARDWARE_MAX_ITEM_LONGTH,"FT8615");
	}else{
