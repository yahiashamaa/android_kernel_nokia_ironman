...
*****************************************************************************/
#define FTS_DRIVER_NAME                     "fts_ts_ft8615"
...
int fts_wait_tp_to_valid(void)
{
	...
	if ((ret < 0) || ((reg_value != chip_id)&&(reg_value != 0x87))) {
            FTS_DEBUG("TP Not Ready, ReadData = 0x%x", reg_value);
         } else if ((reg_value == chip_id)||(reg_value == 0x87)) {
...
#define  CTP_OPEN_SHORT_TEST_INI_NAME	"T99621_Focal_lide.ini"
...
static const struct of_device_id fts_dt_match[] = {
    {.compatible = "focaltech_ft8615,fts", },
    {},
};
