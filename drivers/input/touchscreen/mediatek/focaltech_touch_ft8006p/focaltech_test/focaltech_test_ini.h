...
#define get_value_interface(name, value) \
    fts_ft8006p_get_keyword_value("Interface", name, value)
#define get_value_basic(name, value) \
    fts_ft8006p_get_keyword_value("Basic_Threshold", name, value)
#define get_value_detail(name, value) \
    fts_ft8006p_get_keyword_value("SpecialSet", name, value)
#define get_value_testitem(name, value) \
    fts_ft8006p_get_keyword_value("TestItem", name, value)
#endif /* _INI_H */
