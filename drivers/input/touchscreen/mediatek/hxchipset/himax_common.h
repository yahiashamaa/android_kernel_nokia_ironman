...
#define HIMAX_DRIVER_VER "2.0.0.22_Wingtech_nokia_01"
...
/*#undef CONFIG_DRM_MSM*/ /* Enable it if driver go into suspend/resume twice */
...
#define HX_CONFIG_TOUCHSCREEN_LOCKDOWN_INFO    //lockdown info

#ifdef HX_CONFIG_TOUCHSCREEN_LOCKDOWN_INFO
#define HIMAX_PROC_LOCK_DOWN_INFO_FILE_WT	"lockdown_info"
#endif
/*=============================================*/
...
extern unsigned int bc11_get_register_value(struct regmap *map,
	unsigned int addr,
	unsigned int mask,
	unsigned int shift);
#endif*/
