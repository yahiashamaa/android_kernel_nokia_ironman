...
#define HX_INI_NAME_PATH		"/vendor/etc/mp_hx.ini"
#define HX_FW_FILP_PATH			"/sdcard/ILITEK_FW_HX"
#define HX_INI_REQUEST_PATH		"mp_hx.ini"
#define HX_FW_REQUEST_PATH		"ILITEK_FW_HX"
static unsigned char CTPM_FW_HX[] = {
	#include "FW_TDDI_TRUNK_FB.ili"
};
//-bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test

//+bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
#define SKYWORTH_INI_NAME_PATH		"/vendor/etc/mp_hx.ini"
#define SKYWORTH_FW_FILP_PATH			"/sdcard/ILITEK_FW_SKYWORTH"
#define SKYWORTH_INI_REQUEST_PATH		"mp_hx.ini"
#define SKYWORTH_FW_REQUEST_PATH		"ILITEK_FW_HX"
static unsigned char CTPM_FW_SKYWORTH[] = {
	#include "FW_TDDI_TRUNK_FB_99652.ili"
};
//-bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
