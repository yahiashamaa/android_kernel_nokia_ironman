...
#define HIMAX_DRIVER_VER "2.0.0.56_T99651_02"
 ...
 */
#define HX_PROTOCOL_A //bug558465, sheqihao.wt, MODIFY, 20200601, fix touch jump point
...
#define HX_LCM_RESUME_TS //WVR-4220 sheqihao.wt,Modify,20200730,fix phone screen freeze in call scene
#else
...
//+WVR-4220 sheqihao.wt,Modify,20200730,fix phone screen freeze in call scene
	...
	struct workqueue_struct *ts_lcm_resume_workqueue;
	struct work_struct ts_lcm_resume_work;
#endif
//-WVR-4220 sheqihao.wt,Modify,20200730,fix phone screen freeze in call scene

//+bug558651, sheqihao.wt, MODIFY, 20200604, fix tp abnormal after esd test 

	struct workqueue_struct *ts_susned_workqueue;
	struct work_struct ts_suspend_work;

	struct workqueue_struct *ts_recovery_workqueue;
	struct work_struct ts_recovery_work;
