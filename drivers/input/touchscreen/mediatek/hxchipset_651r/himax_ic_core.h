...
extern int g_is_recovery_done_flag; //bug558651, sheqihao.wt, MODIFY, 20200604, fix tp abnormal after esd test 
#endif
...
/* CORE_FW */
	...
	int (*proc_ctp_chip_test)(struct seq_file *s, void *v);
