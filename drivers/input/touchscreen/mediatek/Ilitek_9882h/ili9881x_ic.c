...
static struct ilitek_ic_func_ctrl func_ctrl[FUNC_CTRL_NUM] = {
	...
	[2] = {"glove", {0x1, 0x6, 0x0}, 3, 0, 0xFF},
	[3] = {"stylus", {0x1, 0x7, 0x0}, 3, 0, 0xFF},
	...
	[15] = {"idle", {0x1, 0x19, 0x0}, 3, 0, 0xFF},
	[16] = {"gesture_demo_en", {0x1, 0x16, 0x0}, 3, 0, 0xFF},
	[17] = {"tp_recore", {0x1, 0x18, 0x0}, 3, 2, 0xFF},
	[18] = {"knock_en", {0x1, 0xA, 0x8, 0x03, 0x0, 0x0}, 6, 0, 0xFF},
	[19] = {"int_trigger", {0x1, 0x1B, 0x0}, 3, 0, 0xFF},
...
//+bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
	...
	if(lcm_name == 7){
		snprintf(firmware_ver,HARDWARE_MAX_ITEM_LONGTH,"SKYWORTH,ILI9882H,FW:%d.%d.%d.%d",buf[1], buf[2], buf[3], buf[4]);
	}else if(lcm_name ==8){
		snprintf(firmware_ver,HARDWARE_MAX_ITEM_LONGTH,"HX,ILI9882H,FW:%d.%d.%d.%d",buf[1], buf[2], buf[3], buf[4]);
	}
	//-Mtr4421, sheqihao.wt, ADD, 20201013, for T99651AA2 tp ili9882h_hx Bringup
	else{
		snprintf(firmware_ver,HARDWARE_MAX_ITEM_LONGTH,"Other vendor,Other IC,FW:Other");
	}
