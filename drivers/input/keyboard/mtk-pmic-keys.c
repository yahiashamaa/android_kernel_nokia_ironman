...
//+bug IRM-16205 jinpeng1.wt 20201019 MODIFY Long press 10s powerkey to shutdown
#ifdef CONFIG_WT_PROJECT_T99621AA3
	printk("mtk_pmic_keys_lp_reset_setup ret=%d,power_off-time-sec =%d \n",ret,long_press_debounce);
#endif
//-bug IRM-16205 jinpeng1.wt 20201019 MODIFY Long press 10s powerkey to shutdown
	if (ret)
