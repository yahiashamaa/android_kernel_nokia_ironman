...
//check67295,tangke.wt,20200921,set T99621AA3 zram to 1GB
...
/* +CHK67552,chenwende.wt,20201020, set zram size to half of totalRam  */
	...
	if(totalram_pages < 262144){// 1G RAM
		...
		disksize = 1610612736;//1.5G
	}else if(totalram_pages < 1048576){// 4G RAM
                disksize = 2147483648;//2G
        }
#endif
/* +CHK67552,chenwende.wt,20201020, set zram size to half of totalRam  */
