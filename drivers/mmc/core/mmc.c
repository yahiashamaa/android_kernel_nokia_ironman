...
MMC_DEV_ATTR(life_time, "0x%02x 0x%02x\n",
	card->ext_csd.device_life_time_est_typ_a,
	card->ext_csd.device_life_time_est_typ_b);
MMC_DEV_ATTR(life_time_est_typ_a, "0x%02x\n",card->ext_csd.device_life_time_est_typ_a);//bug 589772,lizerong.wt,20201014,add life time a node
MMC_DEV_ATTR(life_time_est_typ_b, "0x%02x\n",card->ext_csd.device_life_time_est_typ_b);//bug 589772,lizerong.wt,20201014,add life time b node
...
//+Bug585486 wangguanyu.wt 20200928 add ,add flash_name and vendor node.
    ...
    struct device_attribute *attr, char *buf)
{
    ...
    switch (card->cid.manfid) {
        ...
        case 0x70:
            ...
            if (strncmp(card->cid.prod_name, "TA2832", strlen("TA2832")) == 0)
                emcp_name = "B5116PC2WDGPKR";
            else
#endif
//bug 584789 xuweijiang.wt, Modify, 20201125, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99652AA1
            if (strncmp(card->cid.prod_name, "D26064", strlen("D26064")) == 0)
                emcp_name = "EMMC64G-TD26";
            else
#endif
//bug 584789 xuweijiang.wt, Modify, 20201125, add flash name display,end

//bug 589772 liangsuocheng.wt, Modify, 20201027, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99653AA1
            if (strncmp(card->cid.prod_name, "A29128", strlen("A29128")) == 0)
                emcp_name = "EMMC128G-TA29";
            else if (strncmp(card->cid.prod_name, "D26064", strlen("D26064")) == 0)
                emcp_name = "EMMC64G-TD26";
            else
#endif
//bug 589772 liangsuocheng.wt, Modify, 20201027, add flash name display,end
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99651AA2
            if (strncmp(card->cid.prod_name, "D26032", strlen("D26032")) == 0)
                emcp_name = "B1621XH5ADGTKR";
            else if (strncmp(card->cid.prod_name, "D26064", strlen("D26064")) == 0) {
                emcp_name = "MT53E768M32D2NP";
                vendor_name = "Micron"; // DDR use micron, emmc use kingston
            }
            else
#endif
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,end
                emcp_name = NULL;
            break;
        case 0x90:
            vendor_name = "Hynix";
        ...
        case 0xF4:
            vendor_name = "BIWIN";
#ifdef CONFIG_WT_PROJECT_T99621AA3
            if (strncmp(card->cid.prod_name, "Biwin ", strlen("Biwin ")) == 0)
                emcp_name = "BWMD6X32H2A_16G";
            else
#endif
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99651AA2
            if (strncmp(card->cid.prod_name, "Biwin ", strlen("Biwin ")) == 0)
                emcp_name = "BWMD6X32H2A";
            else
#endif
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,end
//bug 584789 xuweijiang.wt, Modify, 20201125, add flash name display,start
...
#endif
//bug 584789 xuweijiang.wt, Modify, 20201020, add flash name display,end
        ...
        case 0x88:
            vendor_name = "longsys";
#ifdef CONFIG_WT_PROJECT_T99621AA3
            if (strncmp(card->cid.prod_name, "SLD32G", strlen("SLD32G")) == 0)
                emcp_name = "NCLDXC1MC512M32";
            else
#endif
//bug 589772liangsuocheng.wt, Modify, 20201027, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99653AA1
            if (strncmp(card->cid.prod_name, "SLD64G", strlen("SLD64G")) == 0)
                emcp_name = "NCEMASLD-64G";
            else if (strncmp(card->cid.prod_name, "SLD128", strlen("SLD128")) == 0)
                emcp_name = "NCEMASLD-128G";
            else
#endif
//bug 589772 liangsuocheng.wt, Modify, 20201027, add flash name display,end
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,start
            ...
            if (strncmp(card->cid.prod_name, "SLD32G", strlen("SLD32G")) == 0)
                emcp_name = "NCLDXC1MC512M32";
            else if (strncmp(card->cid.prod_name, "SLD64G", strlen("SLD64G")) == 0)
		emcp_name = "NCLDXC1MF768M32";
            else
#endif
//bug 591044 liubaolin.wt, Modify, 20201005, add flash name display,end


//bug 584789 xuweijiang.wt, Modify, 20201020, add flash name display,start
#ifdef CONFIG_WT_PROJECT_T99652AA1
            if (strncmp(card->cid.prod_name, "SLD32G", strlen("SLD32G")) == 0)
                emcp_name = "NCEMASLD-32G";
            else if (strncmp(card->cid.prod_name, "SLD64G", strlen("SLD64G")) == 0)
		emcp_name = "NCEMASLD-64G";
            else
#endif
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_life_time_est_typ_a.attr, //bug 589772,lizerong.wt,20201014,add life time a node
	&dev_attr_life_time_est_typ_b.attr, //bug 589772,lizerong.wt,20201014,add life time b node
