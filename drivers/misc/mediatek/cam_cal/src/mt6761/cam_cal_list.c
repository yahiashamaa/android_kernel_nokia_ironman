...
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	//+ bug590449,cdzk,20200924,add,camera otp bring up
	{IRONMAN_QUNHUI_HI1336_SENSOR_ID, 0xA0, Common_read_region},
	{IRONMAN_DONGCI_HI1336_SENSOR_ID, 0xA0, Common_read_region},
	//- bug590449,cdzk,20200924,add,camera otp bring up
