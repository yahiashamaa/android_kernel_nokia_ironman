...
struct rt1711_chip {
	...
	struct semaphore suspend_lock; // bug 598726 ,xuweijiang,modfiy,20201106,plugging in usb light up
...
static void rt1711_irq_work_handler(struct kthread_work *work)
{
	...
	// bug 598726 ,xuweijiang,modfiy,20201106,plugging in usb light up
	...
	up(&chip->suspend_lock); // bug 598726 ,xuweijiang,modfiy,20201106,plugging in usb light up
