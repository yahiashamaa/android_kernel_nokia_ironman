...
void set_usb_phy_mode(int mode)
{
	...
	//Chk 67947 liangsuocheng.wt add 2020.11.12 add eye parameters
	...
	/* VBUSVALID=1, AVALID=1, BVALID=1, SESSEND=0, IDDIG=0, IDPULLUP=1 */
		...
		USBPHY_SET32(0x6c, (0x3f<<8));
	//wvr-10324 liangsuocheng.wt Modify, 20201226, change eye parameters
	//ROG-2359 xuweijiang.wt, Modify, 20201217, change eye parameters
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 3 << SHFT_RG_USB20_TERM_VREF_SEL);
		break;
	case PHY_IDLE_MODE:
