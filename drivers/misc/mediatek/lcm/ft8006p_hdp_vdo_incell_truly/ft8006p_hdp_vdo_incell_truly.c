...
{0x80,2,{0x5C,0x00}},
{0x41,2,{0x5A,0x09}},
{0x80,5,{0x5C,0x00,0x5C,0x00,0x00}},
{0x41,2,{0x5A,0x0A}},
{0x80,16,{0xA5,0x15,0xA5,0xAA,0xA5,0x88,0x42,0x38,0x03,0x03,0x07,0x05,0x57,0x39,0x4D,0x2F}},
...
{0x41,2,{0x5A,0x0B}},
{0x80,16,{0xFF,0xB4,0xB4,0x00,0x00,0x0E,0x2A,0x43,0x50,0x5D,0x6F,0x7E,0x7F,0x8C,0x8D,0x9F}},
{0x90,16,{0x67,0x57,0x5A,0x51,0x4A,0x40,0x33,0x2A,0x23,0x14,0x03,0x01,0x00,0x0E,0x2A,0x43}},
{0xA0,16,{0x50,0x5D,0x6F,0x7E,0x7F,0x8C,0x8D,0x9F,0x67,0x57,0x5A,0x51,0x4A,0x40,0x33,0x2A}},
{0xB0,5,{0x23,0x14,0x03,0x01,0x00}},
{0x41,2,{0x5A,0x0C}},
...
{0x90,16,{0x4D,0x7A,0x40,0x6C,0x68,0xD2,0x03,0x96,0x40,0x93,0x1E,0xB0,0x08,0x9A,0xF4,0x00}},
{0xA0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x02,0x00,0x00,0x00,0x00,0x00}},
{0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x78,0x5F,0xF7,0x55,0x00,0x80,0x42}},
{0xC0,16,{0xA1,0xF0,0x0E,0x0E,0xEB,0x01,0xA5,0x38,0xDE,0xC0,0x61,0x3D,0xA0,0x14,0xC7,0x0B}},
{0xD0,16,{0x38,0xAC,0x07,0x94,0xE2,0x78,0x05,0x87,0xF5,0x80,0x52,0x1C,0x2F,0xE1,0xB0,0x1E}},
{0xE0,16,{0x50,0x8A,0xE3,0x35,0x1C,0xD6,0x03,0x4A,0x71,0xBC,0x88,0xC3,0x7A,0x40,0x29,0x8E}},
{0xF0,16,{0x57,0x71,0x58,0x0F,0x28,0xC5,0xF1,0x02,0x7E,0xBF,0x31,0x00,0x00,0x00,0x00,0x00}},
{0x41,2,{0x5A,0x15}},
...
{0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x26,0x00,0xE0,0x01,0x28,0x2B,0xB5,0xAE}},
{0xC0,16,{0xEA,0xBA,0x32,0x0C,0x82,0x10,0x04,0x00,0x40,0x6D,0xDB,0xB6,0x6D,0xAB,0x4A,0xEB}},
{0xD0,16,{0xBA,0xAE,0xAB,0x20,0x18,0x86,0xA2,0x38,0x8E,0xD5,0xB6,0x6D,0xDB,0xB6,0xAB,0xB5}},
{0xE0,16,{0xAE,0xEA,0xBA,0x3A,0x8E,0xA2,0x18,0x86,0x20,0x48,0x6D,0xDB,0xB6,0x6D,0xAB,0x42}},
{0xF0,16,{0xEB,0xBA,0xAE,0x2B,0x00,0x10,0x04,0x82,0x30,0x0C,0xD5,0xB6,0x6D,0xDB,0xB6,0x00}},
{0x41,2,{0x5A,0x16}},
...
{0x90,11,{0x0F,0x00,0x00,0x24,0x00,0x00,0x00,0x00,0x00,0x00,0x35}},
{0x41,2,{0x5A,0x26}},
{0x80,16,{0x00,0x83,0x00,0xFB,0xBF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x14,0xC3}},
...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER ft8006p_hdp_vdo_cmd_truly_lcm_drv = {
	.name = "ft8006p_hd_plus_dsi_cmd_truly_lcm_drv",
#else

struct LCM_DRIVER ft8006p_hdp_vdo_incell_truly_lcm_drv = {
	.name = "ft8006p_hdp_vdo_incell_truly",
#endif
