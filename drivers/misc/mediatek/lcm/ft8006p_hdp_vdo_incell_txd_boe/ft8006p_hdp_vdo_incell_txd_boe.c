...
//Blank 10
        {0x41,0x02,{0x5A,0x0A}},
        {0x80,0x10,{0xA5,0x15,0xA5,0xAA,0xA5,0x88,0x42,0x38,0x03,0x03,0x07,0x05,0x4D,0x61,0x46,0x5A}},
        {0x90,0x10,{0x0C,0x0F,0x22,0x00,0x2A,0x18,0x64,0x00,0x88,0x03,0x03,0xEE,0xEE,0x00,0x3F,0x2A}},
...
//Blank 11
        {0x41,0x02,{0x5A,0x0B}},
        {0x80,0x10,{0xFF,0xBE,0xE6,0x00,0x00,0x03,0x0A,0x13,0x1A,0x22,0x30,0x3C,0x3D,0x4A,0x4F,0x69}},
        {0x90,0x10,{0x97,0x7E,0x7B,0x6D,0x62,0x55,0x43,0x38,0x2E,0x1C,0x07,0x01,0x00,0x03,0x0A,0x13}},
        {0xA0,0x10,{0x1A,0x22,0x30,0x3C,0x3D,0x4A,0x4F,0x69,0x97,0x7E,0x7B,0x6D,0x62,0x55,0x43,0x38}},
        {0xB0,0x05,{0x2E,0x1C,0x07,0x01,0x00}},
//Blank 12
        {0x41,0x02,{0x5A,0x0C}},
...
//Blank 13
        {0x41,0x02,{0x5A,0x0D}},
        {0x80,0x10,{0x7A,0xD0,0x02,0xF0,0x05,0xFA,0x00,0xF0,0x00,0x0A,0x0A,0x0A,0x0A,0x00,0x01,0x03}},
...
//Blank 15
        {0x41,0x02,{0x5A,0x0F}},
        {0x80,0x0B,{0xFF,0x00,0x55,0x55,0x32,0x88,0x88,0x1C,0x00,0x5A,0x5A}},
//Blank 16
        {0x41,0x02,{0x5A,0x10}},
...
//Blank 19
        {0x41,0x02,{0x5A,0x13}},
        {0x80,0x10,{0xFD,0x0F,0x00,0x0C,0x00,0x80,0x80,0x87,0x00,0x07,0x22,0x06,0xE7,0xB9,0x86,0x1A}},
        {0x90,0x10,{0x32,0x00,0xA2,0x2D,0x65,0x00,0x00,0x00,0x00,0xD0,0xC9,0xB7,0xFE,0x26,0x6F,0x32}},
        {0xA0,0x03,{0x22,0x90,0x04}},
//Blank 20
        {0x41,0x02,{0x5A,0x14}},
        {0x80,0x10,{0x01,0x02,0x40,0x5E,0xD1,0xDF,0xEF,0xF7,0xFB,0xFD,0x02,0x00,0x00,0xF8,0x8A,0x0F}},
        {0x90,0x10,{0x4D,0x7A,0x40,0x6C,0x68,0xD2,0x03,0xE2,0x42,0x93,0x1E,0x10,0x13,0x9A,0xF4,0x00}},
        {0xA0,0x10,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x02,0x00,0x00,0x00,0x00,0x00}},
        {0xB0,0x10,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x38,0x5F,0xF3,0x55,0x00,0x80,0x42}},
        {0xC0,0x10,{0xA1,0xF0,0x0E,0xF0,0xEB,0x01,0xA5,0x38,0xDE,0x00,0x7E,0x3D,0xA0,0x14,0xC7,0x0B}},
        {0xD0,0x10,{0xC0,0xAF,0x07,0x94,0xE2,0x78,0x05,0xF8,0xF5,0x80,0x52,0x1C,0xEF,0x02,0xBF,0x1E}},
        {0xE0,0x10,{0x50,0x8A,0xE3,0x4D,0xE0,0xD7,0x03,0x4A,0x71,0xBC,0x07,0xFC,0x7A,0x40,0x29,0x8E}},
        {0xF0,0x10,{0xB7,0x80,0x5F,0x0F,0x28,0xC5,0x31,0x02,0x02,0x81,0x10,0x00,0x00,0x00,0x00,0x00}},
//Blank 21
        {0x41,0x02,{0x5A,0x15}},
        {0x80,0x10,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x80,0x7F,0x20}},
        {0x90,0x10,{0x20,0x03,0xF2,0x95,0x88,0x51,0xAB,0x0D,0x22,0x23,0x2F,0x62,0xD4,0x6A,0x83,0xC8}},
        {0xA0,0x10,{0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
        {0xB0,0x10,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x26,0x00,0xE0,0x01,0x28,0x6D,0x68,0x5A}},
        {0xC0,0x10,{0xD2,0x2A,0x18,0x8A,0x03,0xAA,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0x86,0x2A}},
        {0xD0,0x10,{0x44,0xAD,0x0C,0x42,0x00,0xA0,0xD9,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x68}},
        {0xE0,0x10,{0x52,0xD0,0x0A,0x10,0x08,0x03,0xAA,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0x86}},
        {0xF0,0x10,{0xAA,0x64,0xAD,0x8E,0x62,0x08,0xA0,0xD9,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x00}},
//Blank 22
        {0x41,0x02,{0x5A,0x16}},
        {0x80,0x10,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
        {0x90,0x0A,{0x00,0x00,0x00,0x00,0x80,0x42,0x28,0x01,0x00,0x00}},
//Blank 24
        {0x41,0x02,{0x5A,0x18}},
...
//Blank 25
        {0x41,0x02,{0x5A,0x19}},
        {0x80,0x10,{0xC7,0xB5,0xA6,0x9B,0x93,0x8C,0x86,0x81,0x80,0x80,0x80,0x80,0x00,0xF0,0xFF,0xFF}},
        {0x90,0x10,{0xFF,0xFF,0xFF,0xBF,0x7F,0x3F,0x0F,0xFF,0xAF,0xB5,0x71,0x0E,0x6C,0x4A,0x69,0x08}},
        {0xA0,0x04,{0x00,0x00,0x48,0x00}},
//Blank 26
        {0x41,0x02,{0x5A,0x1A}},
...
//Blank 34
        {0x41,0x02,{0x5A,0x22}},
        {0x80,0x10,{0x00,0x5E,0x00,0x00,0x00,0x00,0x00,0x00,0x5E,0x00,0x00,0x00,0x00,0x00,0x00}},
//Blank 36
        {0x41,0x02,{0x5A,0x24}},
        {0x80,0x10,{0x2D,0xD3,0x00,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x9F,0x00,0xAA,0x3E,0x00}},
...
//Blank 38
        {0x41,0x02,{0x5A,0x26}},
        {0x80,0x10,{0x00,0x83,0x00,0xFF,0xFF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0xB4,0xBB}},
...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER ft8006p_hdp_vdo_cmd_boe_lcm_drv = {
	.name = "ft8006p_hd_plus_dsi_cmd_boe_lcm_drv",
#else

struct LCM_DRIVER ft8006p_hdp_vdo_incell_txd_boe_lcm_drv = {
	.name = "ft8006p_hdp_vdo_incell_txd_boe",
#endif
