...
{0xFF, 03,{0x98,0x82,0x08}},
		   //0x40,0x24,0x98,0xD1,0x10,0x55,0x40,0x64,0x8D,0xAD,0xA9,0xDF,0x05,0x25,0x45,0xAA,0x65,0x8D,0xA7,0xCA,0xFE,0xE9,0x12,0x44,0x6B,0x03,0xEC
...
#else
	//bug568912, sheqihao.wt, MODIFY, 20200703, fix LCD panel Flicker
...
struct LCM_DRIVER ili9882h_hdp_vdo_incell_hx_lcm_drv = {
	.name = "ili9882h_hdp_vdo_incell_hx",
#endif
