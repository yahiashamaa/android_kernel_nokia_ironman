...
static struct LCM_setting_table init_setting_vdo[] = {
        ...
        {0xB1, 11, {0x22,0x22,0x2B,0x2B,0x32,0x77,0x57,0x48,0x08,0x08,0x08}},

        {0xB2, 14, {0x00,0x00,0x05,0xF0,0x00,0x10,0xC3,0x68,0x00,0x00,0x00,0x00,0xF4,0xA0}},

        {0xB4, 14, {0x55,0x3E,0x55,0x3E,0x55,0x3E,0x55,0x3E,0x01,0xFF,0x01,0x20,0x00,0xFF}},

        {0xCC, 1, {0x02}},

        {0xD3, 28, {0x11,0x00,0x01,0x00,0x00,0x08,0x00,0x47,0x00,0x44,0x4F,0x09,0x09,0x00,0x00,0x42,0x10,0x05,0x00,0x01,0x32,0x10,0x07,0x00,0x06,0x32,0x16,0x04}},
        {REGFLAG_DELAY, 5, {}},

        {0xBD, 1, {0x01}},

        {0xD3, 3, {0x01,0x00,0x78}},
        {REGFLAG_DELAY, 5, {}},

        {0xBD, 1, {0x00}},

        {0xE0, 46,  {0x00,0x02,0x07,0x0C,0x11,0x16,0x2B,0x32,0x3A,0x38,0x55,0x5E,0x67,0x7B,0x7D,0x8B,0x97,0xAD,0xB0,0x58,0x61,0x6E,0x7F,0x00,0x02,0x07,0x0C,0x11,0x16,0x2B,0x32,0x3A,0x38,0x55,0x5E,0x67,0x7B,0x7D,0x8B,0x97,0xAD,0xB0,0x58,0x61,0x6E,0x7F}},

        {0xD5, 44, 				  {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x3A,0x3A,0x28,0x28,0x18,0x18,0x01,0x00,0x03,0x02,0x05,0x04,0x07,0x06,0x18,0x18,0x21,0x20,0x25,0x22,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18}},
        {REGFLAG_DELAY, 5, {}},

        {0xE7, 23, {0xFF,0x0F,0x00,0x00,0x20,0x20,0x0F,0x0F,0x17,0x13,0x1A,0x85,0x00,0x85,0x00,0x00,0x00,0x00,0x00,0x00,0x17,0x10,0x68}},
        ...
        {0xCB, 5, {0x00,0x13,0x00,0x02,0x71}},
        ...
        {0xB9, 3, {0x83,0x10,0x2D}}, //IC pass word
        {0xCD, 1, {0x01}},         //CRC CHECK
};
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 195;
...
struct LCM_DRIVER hx83102d_hdp_vdo_incell_lide_lcm_drv = {
	.name = "hx83102d_hdp_vdo_incell_lide",
#endif
