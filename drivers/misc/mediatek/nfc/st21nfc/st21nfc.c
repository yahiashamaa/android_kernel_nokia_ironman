...
/*++bug605534 add board ID for compatible NFC and NON-NFC 20201203 jinzhao */
extern char *saved_command_line;
static int __init st21nfc_dev_init(void) {
  //printk("board_id found in cmdline : %s\n", saved_command_line);
  if(strstr(saved_command_line,"board_id=T99653JA1") ||
	strstr(saved_command_line,"board_id=T99653KA1") ||
	strstr(saved_command_line,"board_id=T99653IA1")){
