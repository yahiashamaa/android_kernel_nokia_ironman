...
#include "ironman_qunhui_hi1336mipiraw_Sensor.h"

#define PFX "qunhui_hi1336_camera_sensor"

#undef LOG_INF
#define QUNHUI_HI1336_DEBUG 0
#if QUNHUI_HI1336_DEBUG
#define LOG_INF(format, args...) pr_info(PFX "INFO""[%s] " format, __func__, ##args)
#else
#define LOG_INF(format, args...)
#endif

#define LOG_ERR(format, args...) pr_err(PFX "INFO""[%s] " format, __func__, ##args)
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = IRONMAN_QUNHUI_HI1336_SENSOR_ID,
