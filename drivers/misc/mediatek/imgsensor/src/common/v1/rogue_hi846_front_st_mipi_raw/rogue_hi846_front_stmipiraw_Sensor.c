...
#include "rogue_hi846_front_stmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = ROGUE_HI846_FRONT_ST_SENSOR_ID,
	...
	.slim_video_delay_frame = 3,
        ...
        //bug596770 zhouyikuan.wt, modify, 2020/11/11,fix front hi846 camera RF interference
...
static struct stCAM_CAL_DATAINFO_STRUCT rogue_hi846_front_st_eeprom_data ={
	.sensorID= ROGUE_HI846_FRONT_ST_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x077C,
...
static struct stCAM_CAL_CHECKSUM_STRUCT rogue_hi846_front_st_checksum[8] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 retry = 2;
        ...
        //+bug584789,zhouyikuan.wt,ADD,2020/10/30,HI846 otp bring up
	kal_int32 rc = 0;
