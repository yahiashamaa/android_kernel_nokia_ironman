...
#include "wr_bf2253_depth_qh_mipi_raw.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "wr_bf2253_depth_qh_camera_sensor"
#define LOG_1 LOG_INF("WR_BF2253_DEPTH_QH, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool WR_BF2253_DEPTH_QHDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = WR_BF2253_DEPTH_QH_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	WR_BF2253_DEPTH_QHDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
