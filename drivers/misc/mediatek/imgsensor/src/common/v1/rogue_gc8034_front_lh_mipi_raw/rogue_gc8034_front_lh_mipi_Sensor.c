...
#include "rogue_gc8034_front_lh_mipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = ROGUE_GC8034_FRONT_LH_SENSOR_ID,
...
//+bug596770 zhouyikuan.wt, modify, 2020/11/13,add DD data bad pixel correction
...
static struct stCAM_CAL_DATAINFO_STRUCT rogue_gc8034_front_lh_eeprom_data ={
    .sensorID= ROGUE_GC8034_FRONT_LH_SENSOR_ID,
    .deviceID = 0x02,
    .dataLength = 0x76A,
...
static struct stCAM_CAL_CHECKSUM_STRUCT rogue_gc8034_front_lh_checksum[8] =
{
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                //+bug584789,zhouyikuan.wt,ADD,2020/11/04,GC8034 eeprom bring up
                size = imgSensorReadEepromData(&rogue_gc8034_front_lh_eeprom_data,rogue_gc8034_front_lh_checksum);
                if(size != rogue_gc8034_front_lh_eeprom_data.dataLength || (rogue_gc8034_front_lh_eeprom_data.sensorVendorid >> 24)!= read_rogue_gc8034_eeprom(0x0001)) {
                    pr_err("get eeprom data failed\n");
                    if(rogue_gc8034_front_lh_eeprom_data.dataBuffer != NULL) {
                        kfree(rogue_gc8034_front_lh_eeprom_data.dataBuffer);
                        rogue_gc8034_front_lh_eeprom_data.dataBuffer = NULL;
                    }
                    *sensor_id = 0xFFFFFFFF;
                    return ERROR_SENSOR_CONNECT_FAIL;
                } else {
                    pr_debug("get eeprom data success\n");
                    imgSensorSetEepromData(&rogue_gc8034_front_lh_eeprom_data);
                }
                                //-bug584789,zhouyikuan.wt,ADD,2020/11/04,GC8034 eeprom bring up
                return ERROR_NONE;
            }
