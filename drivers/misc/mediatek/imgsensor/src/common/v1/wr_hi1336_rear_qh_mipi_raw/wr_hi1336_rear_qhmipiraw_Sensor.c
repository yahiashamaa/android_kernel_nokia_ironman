...
#define per_frame 1
extern bool read_wr_hi1336_rear_qh_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = WR_HI1336_REAR_QH_SENSOR_ID,
	...
	//+bug550253 chenbocheng.wt, add, 2020/6/3, add custom2 for rear camera nightscape mode
	.custom2 = {
		.pclk = 600000000,
		.linelength = 6004,
		.framelength = 3330,
...
static kal_uint16 wr_hi1336_rear_qh_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_wr_hi1336_rear_qh[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
static void sensor_init(void)
{
	...
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_init_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_init_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_wr_hi1336_rear_qh[] = {
...
static void preview_setting(void)
{
	...
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_preview_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_preview_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_wr_hi1336_rear_qh[] = {
...
static kal_uint16 addr_data_pair_capture_15fps_wr_hi1336_rear_qh[] = {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps > 150) {
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_capture_30fps_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));

	} else {
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_capture_15fps_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
	}
#else
	...
	if( currefps > 150) {
		...
		write_cmos_sensor(0x1038, 0x4100);
		write_cmos_sensor(0x1042, 0x1108);
		write_cmos_sensor(0x1048, 0x0080);
		write_cmos_sensor(0x1044, 0x0100);
		write_cmos_sensor(0x1046, 0x0004);
		write_cmos_sensor(0x104c, 0x0000);
...
static kal_uint16 addr_data_pair_video_hi1336[] = {
	...
	0x1018, 0x0040,
	0x101a, 0x006a,
//+WVR-9618, cdzk, modify, 20201217, Click More in portrait mode to select time-lapse photography, the lens is stuck
	0x1038, 0x0000,
	0x1042, 0x0008,
//+WVR-9618, cdzk, modify, 20201217, Click More in portrait mode to select time-lapse photography, the lens is stuck
	0x1048, 0x0080,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_wr_hi1336_rear_qh[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe4b0,
	0x1118, 0x0072,
...
static void hs_video_setting(void)
{
...
#if MULTI_WRITE
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_hs_video_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_hs_video_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
#else
	...
	write_cmos_sensor(0x1010, 0x0300);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_wr_hi1336_rear_qh[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
static void slim_video_setting(void)
{
	...
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_slim_video_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_slim_video_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
#else
...
static void custom1_setting(void){
	...
	write_cmos_sensor(0x0730, 0x770f);
	write_cmos_sensor(0x0732, 0xe0b0);
	write_cmos_sensor(0x1118, 0x0156);
	write_cmos_sensor(0x1200, 0x011f);
	write_cmos_sensor(0x1204, 0x1c01);
	write_cmos_sensor(0x1240, 0x0100);
	write_cmos_sensor(0x0b20, 0x8100);
	...
	write_cmos_sensor(0x102c, 0x2400);
	write_cmos_sensor(0x1010, 0x07d0);
	write_cmos_sensor(0x1012, 0x02a4);
	write_cmos_sensor(0x1014, 0x0107);
	write_cmos_sensor(0x1016, 0x0107);
	write_cmos_sensor(0x1018, 0x0040);
	write_cmos_sensor(0x101a, 0x0107);
	write_cmos_sensor(0x1038, 0x4100);
	write_cmos_sensor(0x1042, 0x1108);
	write_cmos_sensor(0x1048, 0x0064);
	write_cmos_sensor(0x1044, 0x00d0);
	write_cmos_sensor(0x1046, 0x0004);
	write_cmos_sensor(0x104c, 0x0707);
	write_cmos_sensor(0x0404, 0x0008);
	write_cmos_sensor(0x0406, 0x1087);
	write_cmos_sensor(0x0220, 0x0008);
	write_cmos_sensor(0x022a, 0x0017);
...
//+bug550253 chenbocheng.wt, add, 2020/6/3, add custom2 for rear camera nightscape mode
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_30fps_wr_hi1336_rear_qh[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static void custom2_setting(void)
{
	...
	wr_hi1336_rear_qh_table_write_cmos_sensor(
		addr_data_pair_custom2_30fps_wr_hi1336_rear_qh,
		sizeof(addr_data_pair_custom2_30fps_wr_hi1336_rear_qh) /
		sizeof(kal_uint16));
#else
...
static struct stCAM_CAL_DATAINFO_STRUCT hi1336_txd_eeprom_data ={
	.sensorID= WR_HI1336_REAR_QH_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0CF9,
	.sensorVendorid = 0x0A000000,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
...
//-bug550253 chenbocheng.wt, modify, 2020/5/27, the gc5035 otp porting
