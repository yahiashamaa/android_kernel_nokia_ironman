...
#include "rogue_bf2253_dep_lh_mipi_raw.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "rogue_bf2253_dep_lh_camera_sensor"
#define LOG_1 LOG_INF("ROGUE_BF2253_DEP_LH, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool ROGUE_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = ROGUE_BF2253_DEP_LH_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	ROGUE_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
