...
#include "ironman_qunhui_gc5035mipi_Sensor.h"

#undef LOG_INF
#define QUNHUI_GC5035_DEBUG 0
#define FLAG_DD_DEBUG 0
#if QUNHUI_GC5035_DEBUG
...
#define PFX "qunhui_gc5035_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IRONMAN_QUNHUI_GC5035_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
			...
			*sensor_id = return_sensor_id() + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
                                    moduleId = gc5035_otp_identify();
                                        if ( moduleId == QUNHUI_GC5035_OTP_MODULE_ID) {
                                                        imgsensor_info.module_id = QUNHUI_GC5035_OTP_MODULE_ID;
	...
	if (*sensor_id != imgsensor_info.sensor_id || moduleId != QUNHUI_GC5035_OTP_MODULE_ID) {
