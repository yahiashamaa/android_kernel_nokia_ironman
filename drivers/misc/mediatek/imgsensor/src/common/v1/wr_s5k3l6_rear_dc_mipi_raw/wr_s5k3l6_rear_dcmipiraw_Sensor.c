 ...
 * Filename:
 * ---------
 *	 wr_s5k3l6_rear_dcmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "wr_s5k3l6_rear_dcmipiraw_Sensor.h"
...
//+bug550253 chenbocheng.wt, modify, 2020/5/27,the s5k3l6 otp porting
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = WR_S5K3L6_REAR_DC_SENSOR_ID,
	...
	.custom1 = {
		...
		.framelength = 3028,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
...
//+IRM-18877, cdzk, modify, 20201201, pdaf config.
...
static struct stCAM_CAL_DATAINFO_STRUCT dongci_rear_s5k3l6_eeprom_data ={
	.sensorID= WR_S5K3L6_REAR_DC_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0CF9,
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) |
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(size != dongci_rear_s5k3l6_eeprom_data.dataLength || (dongci_rear_s5k3l6_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001)) {
...
UINT32 WR_S5K3L6_REAR_DC_MIPI_RAW_SensorInit(
