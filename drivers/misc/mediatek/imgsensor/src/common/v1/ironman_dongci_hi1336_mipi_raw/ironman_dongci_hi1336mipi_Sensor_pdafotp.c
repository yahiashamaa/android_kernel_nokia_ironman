...
static BYTE hi1336_eeprom_data[DATA_SIZE]= {0};
...
static bool getPDAFCalDataFromFile(void)
{
   bool Flag = false;
   int fd;
...
bool read_hi1336_eeprom_dongci( kal_uint16 addr, BYTE* data, kal_uint32 size)
{
 	bool Flag;
	addr = 0x0800;
	size = 1404;
...
bool read_eeprom_dongci( kal_uint16 addr, BYTE* data, kal_uint32 size)
{
	BYTE af_pos[4];
