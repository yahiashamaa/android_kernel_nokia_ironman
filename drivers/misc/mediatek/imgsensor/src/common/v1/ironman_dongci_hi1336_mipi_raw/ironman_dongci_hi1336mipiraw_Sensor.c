...
#include "ironman_dongci_hi1336mipiraw_Sensor.h"

#undef LOG_INF
#define DONGCI_HI1336_DEBUG 0
#if DONGCI_HI1336_DEBUG
#define LOG_INF(format, args...) pr_info(PFX "[%s] " format, __func__, ##args)
#else
#define LOG_INF(format, args...)
#endif

#define PFX "dongci_hi1336_camera_sensor"
...
extern bool read_hi1336_eeprom_dongci( kal_uint16 addr, BYTE *data, kal_uint32 size); 
extern bool read_eeprom_dongci( kal_uint16 addr, BYTE * data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = IRONMAN_DONGCI_HI1336_SENSOR_ID,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.iMirrorFlip = 0,
	.i4PosR =	{
                                {58,31}, {74,31}, {66,35}, {82,35},
                                {58,47}, {74,47}, {66,51}, {82,51},
                            },
	.i4PosL =	{
                                {58,27}, {74,27}, {69,39}, {82,39},
                                {58,43}, {74,43}, {66,55}, {82,55},
                            }
...
//extern void getWingtechLscPdafDataFromHW(void);
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			sensor_id = return_sensor_id() + 1; //dongci 0x1336+1
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_STREAMING_RESUME:
		...
		// read from e2prom
#if e2prom
		read_eeprom_dongci((kal_uint16)(*feature_data), 
		...
		read_hi1336_eeprom_dongci((kal_uint16)(*feature_data), 
				(char *)(uintptr_t)(*(feature_data+1)), 
				(kal_uint32)(*(feature_data+2)) );
