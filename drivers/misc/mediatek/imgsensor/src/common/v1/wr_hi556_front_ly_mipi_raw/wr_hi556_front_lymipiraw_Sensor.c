...
#include "wr_hi556_front_lymipiraw_Sensor.h"

#define PFX "wr_hi556_front_ly_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = WR_HI556_FRONT_LY_SENSOR_ID,
...
static kal_uint16 wr_hi556_front_ly_table_write_cmos_sensor(
...
//+bug550253 chenbocheng.wt, modify, 2020/7/22, disalbe otp data print
...
#define AWB_GROUP1_FLAG 0x40A
#define LSC_GROUP1_FLAG 0x41C
...
static int read_hi556_module_info(void)
{
	...
	/* read flag */
	for(i = 0; i < 3; i++){
		write_cmos_sensor_8(0x010a,(((MODULE_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)>>8)&0xff);
		write_cmos_sensor_8(0x010b,((MODULE_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)&0xff);
		write_cmos_sensor_8(0x0102,0x01);
		otp_grp_flag = read_cmos_sensor(0x0108);

		if(otp_grp_flag == VALID_OTP_FLAG){
			minfo_start_addr = (MODULE_GROUP1_FLAG) + (OTP_GROUP_OFFSET)*i + 1;
			LOG_INF("the group:%i is valid,otp_grp_flag = 0x%x,info_start_addr:0x%x\n",i,otp_grp_flag,minfo_start_addr);
			break;
		}
	}
	if(otp_grp_flag != VALID_OTP_FLAG){
...
static int read_hi556_awb_info(void)
{
	...
	/* awb group 1 */
	for(i = 0; i < 3; i++){
		write_cmos_sensor_8(0x010a,(((AWB_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)>>8)&0xff);
		write_cmos_sensor_8(0x010b,((AWB_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)&0xff);
		write_cmos_sensor_8(0x0102,0x01);
		otp_grp_flag = read_cmos_sensor(0x0108);

		if(otp_grp_flag == VALID_OTP_FLAG){
			awb_start_addr = (AWB_GROUP1_FLAG) + (OTP_GROUP_OFFSET)*i + 1;
			LOG_INF("the group:%i is valid,otp_grp_flag = 0x%x,awb_start_addr:0x%x\n",i,otp_grp_flag,awb_start_addr);
			break;
		}
	}
	if(otp_grp_flag != VALID_OTP_FLAG){
...
static int read_hi556_lsc_info(void)
{
	...
	/* lsc group 1 */
	for(i = 0; i < 3; i++){
		write_cmos_sensor_8(0x010a,(((LSC_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)>>8)&0xff);
		write_cmos_sensor_8(0x010b,((LSC_GROUP1_FLAG)+(OTP_GROUP_OFFSET)*i)&0xff);
		write_cmos_sensor_8(0x0102,0x01);
		otp_grp_flag = read_cmos_sensor(0x0108);

		if(otp_grp_flag == VALID_OTP_FLAG){
			lsc_start_addr = (LSC_GROUP1_FLAG) + (OTP_GROUP_OFFSET)*i + 1;
			LOG_INF("the group:%i is valid,otp_grp_flag:0x%x,lsc_start_addr:0x%x\n",i,otp_grp_flag,lsc_start_addr);
			break;
		}
	}
	if(otp_grp_flag != VALID_OTP_FLAG){
...
//-bug550253 chenbocheng.wt, modify, 2020/5/27,the hi556 otp porting
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_wr_hi556_front_ly[] = {
	0x0a00, 0x0000,
	0x0e00, 0x0102,
	0x0e02, 0x0102,
	0x0e0c, 0x0100,
...
{
#if MULTI_WRITE
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_init_wr_hi556_front_ly,
		sizeof(addr_data_pair_init_wr_hi556_front_ly) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_wr_hi556_front_ly[] = {
	0x0b0a, 0x8259,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_preview_wr_hi556_front_ly,
		sizeof(addr_data_pair_preview_wr_hi556_front_ly) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_wr_hi556_front_ly[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_wr_hi556_front_ly[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_wr_hi556_front_ly,
		sizeof(addr_data_pair_capture_30fps_wr_hi556_front_ly) /
		sizeof(kal_uint16));
	} else {
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_capture_fps_wr_hi556_front_ly,
		sizeof(addr_data_pair_capture_fps_wr_hi556_front_ly) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
		...
		write_cmos_sensor(0x0030, 0x1111);
		write_cmos_sensor(0x0032, 0x1111);
		write_cmos_sensor(0x0006, 0x1043);
		write_cmos_sensor(0x0a22, 0x0000);
		write_cmos_sensor(0x0a12, 0x0a20);
		write_cmos_sensor(0x0a14, 0x0798);
		write_cmos_sensor(0x003e, 0x0000);
		write_cmos_sensor(0x0074, 0x1041);
		write_cmos_sensor(0x0070, 0x0400);
		write_cmos_sensor(0x0804, 0x0200);
		write_cmos_sensor(0x0a04, 0x014a);
		write_cmos_sensor(0x090c, 0x0fdc);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_wr_hi556_front_ly[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7267,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_hs_video_wr_hi556_front_ly,
		sizeof(addr_data_pair_hs_video_wr_hi556_front_ly) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6e25);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_wr_hi556_front_ly[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_slim_video_wr_hi556_front_ly,
		sizeof(addr_data_pair_slim_video_wr_hi556_front_ly) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6e25);
...
//+bug550253 chenbocheng.wt, add, 2020/6/3, add custom1 for front camera portrait mode
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_30fps_wr_hi556_front_ly[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	wr_hi556_front_ly_table_write_cmos_sensor(
		addr_data_pair_custom1_30fps_wr_hi556_front_ly,
		sizeof(addr_data_pair_custom1_30fps_wr_hi556_front_ly) /
		sizeof(kal_uint16));
#else
	LOG_INF("custom1_setting fps = 300\n");
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6e25);
	write_cmos_sensor(0x0f32, 0x7067);
	write_cmos_sensor(0x004a, 0x0100);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err("wr_hi556_front_ly i2c write id : 0x%x, sensor id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("wr_hi556_front_ly Read id fail,sensor id: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
