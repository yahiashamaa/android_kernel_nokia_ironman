...
//+Bug 597174,lishuwen.wt,2020.11.06,modify,add charger current nod
	...
	int (*enable_vbus)(struct charger_device *dev, bool en);
#endif
#endif
//-Bug 597174,lishuwen.wt,2020.11.06,modify,add charger current nod
...
//+ Bug585485, jinpeng1@WT, 20200917, modify,add charger driver(bq24157) 
#ifdef CONFIG_MTK_BQ24157_SUPPORT
    void (*charger_set_wakelock) (struct charger_device *chg_dev,bool chg_online);	
#endif
//- Bug585485, jinpeng1@WT, 20200917, add charger driver(bq24157) 
};
...
#ifdef WT_COMPILE_FACTORY_VERSION
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
extern int charger_dev_enable_vbus(struct charger_device *charger_dev, bool en);
#endif
#endif
//+Bug 597174,lishuwen.wt,2020.11.06,modify,add charger current nod
