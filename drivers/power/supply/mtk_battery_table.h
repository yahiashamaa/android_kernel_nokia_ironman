...
#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
#define VIR_OLDOCV_DIFF_EMB			4500	/* 1000mV */
#define VIR_OLDOCV_DIFF_EMB_LT		4500	/* 1000mV */
#else
...
//+ bug585485 jinpeng1.wt 20200927 MODIFY modify battery NTC parameters
/* Qmax for battery  */
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
//+ Bug 591035, lishuwen@WT, add battery curve, 20201104
#if defined (CONFIG_WT_PROJECT_T99621AA3)
	{ 4000, 4000, 4000, 4000},/*T0*/
	{ 4000, 4000, 4000, 4000},/*T1*/
	{ 3926, 3920, 3920, 3920},/*T2*/
	{ 3826, 3674, 3674, 3674},/*T3*/
	{ 3228, 2976, 2976, 2976},/*T4*/
#elif defined (CONFIG_WT_PROJECT_T99651AA2)
	{ 4401, 4479, 4479, 4479},/*T0*/
	{ 4448, 4485, 4485, 4485},/*T1*/
	{ 4443, 4470, 4470, 4470},/*T2*/
	{ 4424, 4494, 4494, 4494},/*T3*/
	{ 4033, 4548, 4548, 4548},/*T4*/
#else
...
//+ Bug 591035, lishuwen@WT, add battery curve, 20201104
	...
	{ 3228, 2976, 2976, 2976},/*T4*/
#elif defined (CONFIG_WT_PROJECT_T99651AA2)
	{ 4380, 4460, 4460, 4460},/*T0*/
	{ 4418, 4460, 4460, 4460},/*T1*/
	{ 4311, 4410, 4410, 4410},/*T2*/
	{ 4033, 4179, 4179, 4179},/*T3*/
	{ 3176, 3273, 3273, 3273},/*T4*/
#else
...
//+ bug585485 jinpeng1.wt 20200927 MODIFY modify battery NTC parameters
//bug 589756, yaocankun, add, 20201015, for battery ntc
...
#endif
#endif
//+chk 67763,lishuwen.wt,2020.10.16,add ntc parameter
