...
//bug 589756, yaocankun, mod, 20201010, for charger bringup
#if defined(CONFIG_MTK_BQ24157_SUPPORT) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
		val->intval =
...
//-bug 585485, jinpeng1,20201110,modify, porting code for chargeIC  HL7057 battery capacity
	if (active_table == 0 && multi_battery == 0) {
		bm_err("the charger IC is eta6937\n");
