...
//+bug 585485 jinpeng1.wt 20201022 MODIFY charger up later problem
#ifdef CONFIG_WT_PROJECT_T99621AA3
extern bool check_hl7057(void);
#endif
//-bug 585485 jinpeng1.wt 20201022 MODIFY charger up later problem
struct tag_bootmode {
	u32 size;
...
#define WT_CHG_TERM_CURRENT (-250)
...
//+bug 585485 jinpeng1.wt 20201022 MODIFY charger up later problem
    ...
    if (check_hl7057())
    {
        info->data.ac_charger_current = 1750000;
        info->data.jeita_temp_t2_to_t3_cc = 1750000;
        info->data.jeita_temp_t3_to_t4_cc = 1750000;
	chr_err("mtk_charger check_hl7057 true\n");
    }
