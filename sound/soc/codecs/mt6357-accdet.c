...
//+bug607060, liujin.wt, add , 20201211,for boot sound when insert headset 
...
//+bug607060, liujin.wt, add , 20201211,for boot sound when insert headset 
#if JUST_INPUT_NO_SWITCH
	switch_set_state((struct switch_dev *)&accdet_data, accdet->cable_type);
#endif
//-bug607060, liujin.wt, add , 20201211,for boot sound when insert headset 
...
//+bug607060, liujin.wt, add , 20201211,for boot sound when insert headset 
	...
	if (ret) {
		pr_info("[Accdet]switch_dev_register returned:%d!\n", ret);
		return 1;
	}
#endif
//-bug607060, liujin.wt, add , 20201211,for boot sound when insert headset 
